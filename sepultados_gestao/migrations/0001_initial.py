    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('situacao', models.CharField(choices=[('ativo', 'Ativo'), ('arquivado', 'Arquivado')], db_index=True, default='ativo', max_length=12, verbose_name='Situação')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('situacao', models.CharField(choices=[('ativo', 'Ativa'), ('arquivado', 'Arquivada'), ('suspenso', 'Suspensa')], db_index=True, default='ativo', max_length=12, verbose_name='Situação')),
                ...
                ('usuario', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='prefeituras_gerenciadas', to=settings.AUTH_USER_MODEL, verbose_name='Usuário responsável')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tumulo_destino', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='sepultados_gestao.tumulo')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='prefeitura',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sepultados_gestao.prefeitura', verbose_name='Prefeitura'),
        ),
        migrations.AddField(
            model_name='concessaocontrato',
            name='tumulo',
